<template>
  ...
  >
    ...
    >
      <div
        v-if="isOpen"
        class="absolute right-0 z-50 mt-1 min-w-[160px] origin-top-right rounded-lg border border-gray-200 bg-white py-1 shadow-lg dark:border-gray-600 dark:bg-gray-800"
      >
        <slot />
      </div>
    </Transition>
